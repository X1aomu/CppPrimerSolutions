...
int OperateAdd(const int &a, const int &b) {
  return a + b;
}
int OperateSubstract(const int &a, const int &b) {
  return a - b;
}
int OperateMultiple(const int &a, const int &b) {
  return a * b;
}
int OperateDivided(const int &a, const int &b) {
  return a / b;
}
